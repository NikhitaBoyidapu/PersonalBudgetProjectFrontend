...
function DeleteCategory() {
  ...
  function handleSubmit(event) {
    ...
    axios
      .post(
        'https://seashell-app-pjx64.ondigitalocean.app/deletebudget',
        {
          title,
          username,
          month,
  ...
  const getTitles = () => {
    axios
      .get(`https://seashell-app-pjx64.ondigitalocean.app/gettitles/${username}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
      .then((res) => {
        ...
        // Iterate through the results and create a hashmap
        ...
        // Update state with the hashmap and unique titles
          ...
          <div className="input-box">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setMonth(''); // Reset selected month when title changes
              }}
              required
            >
